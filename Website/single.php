<?php
print('<h3> this works</h3>');
// if (session_status() == PHP_SESSION_NONE){
//  session_start();
}

$h1 = null;
                if($_SESSION !== NULL && array_key_exists('Username', $_SESSION) ){
...
<body>
  ...
  <div>
    ...
    <?php 
    print('<input type="hidden" name="prod_name" value="' .$Name. '" >' );
    print('<input type="hidden" name="domain" value="' .implode(' ',$matches_out[0]). '" >' );
    print('<input type="hidden" name="username" value="' .$h1. '" >' );
    ?>

  <div>
    <ul>
      <li>
        <label id="label_6" for="input_6"> Rating: </label>
        <div id="cid_6">
          <table cellpadding="4" cellspacing="0" data-component="scale">
            <tbody>
              <tr>
                <th>
                   
              ...
              <tr>
                ...
                <td style="text-align:center;">
                  <input type="radio" name="q6_rating" value="1" title="1" id="input_6_1" />
                </td>
                <td style="text-align:center;">
                  <input type="radio" name="q6_rating" value="2" title="2" id="input_6_2" />
                </td>
                <td style="text-align:center;">
                  <input type="radio" name="q6_rating" value="3" title="3" id="input_6_3" />
                </td>
                <td style="text-align:center;">
                  <input type="radio" name="q6_rating" value="4" title="4" id="input_6_4" />
                </td>
                <td style="text-align:center;">
                  <input type="radio" name="q6_rating" value="5" title="5" id="input_6_5" />
                </td>
                <td>
      ...
      <li data-type="control_textarea" id="id_7">
        <label id="label_7" for="input_7"> Review </label>
        <div id="cid_7">
          <textarea id="input_7" name="q7_review" cols="28" rows="6"></textarea>
        </div>
      </li>
      <li data-type="control_button" id="id_2">
        <div id="cid_2">
          <div style="text-align:left;">
            <button id="input_2" type="submit" data-component="button">
              Submit
            </button>
          </div>
        </div>
